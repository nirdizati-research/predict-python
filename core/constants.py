...
NAIVE_BAYES = MultinomialNB().__class__.__name__
...
INCREMENTAL_SGDC = 'incremental' + SGDCLASSIFIER
INCREMENTAL_PERCEPTRON = 'incremental' + PERCEPTRON
...
CLASSIFICATION_INCREMENTAL_SGDC = '{}.{}'.format(CLASSIFICATION, INCREMENTAL_SGDC)
CLASSIFICATION_INCREMENTAL_PERCEPTRON = '{}.{}'.format(CLASSIFICATION, INCREMENTAL_PERCEPTRON)
...
all_configs = [
    ...
    CLASSIFICATION_INCREMENTAL_SGDC,
