...
class Complex(TestCase):
    ...
    def test_shape(self):
        df = complex(self.log, self.label, self.add_col, prefix_length=2)
    ...
    def test_prefix1(self):
        df = complex(self.log, self.label, self.add_col, prefix_length=1)
    ...
    def test_prefix1_no_label(self):
        ...
        df = complex(self.log, label, self.add_col, prefix_length=1)
    ...
    def test_prefix1_no_elapsed_time(self):
        df = complex(self.log, LabelContainer(), self.add_col, prefix_length=1)
    ...
    def test_prefix5(self):
        df = complex(self.log, self.label, self.add_col, prefix_length=5)

        self.assertEqual(df.shape, (2, 28))

    def test_prefix10(self):
        df = complex(self.log, self.label, self.add_col, prefix_length=10)

        self.assertEqual(df.shape, (1, 53))

    def test_prefix10_zero_padding(self):
        df = complex(self.log, self.label, self.add_col, prefix_length=10, zero_padding=True)
