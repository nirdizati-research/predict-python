...
<head>
    ...
    <title>Coverage for /home/musabir/.local/lib/python3.6/site-packages/ws4redis/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/musabir/.local/lib/python3.6/site-packages/ws4redis/__init__.py</b> :
...
<div id="source">
    ...
    <p id="t2" class="run"><span class="n"><a href="#t2">2</a></span><span class="t"><span class="nam">__version__</span> <span class="op">=</span> <span class="str">'0.6.0'</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
