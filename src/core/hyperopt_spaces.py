...
from src.core.constants import CLASSIFICATION_RANDOM_FOREST, CLASSIFICATION_KNN, CLASSIFICATION_XGBOOST, \
    CLASSIFICATION_MULTINOMIAL_NAIVE_BAYES, CLASSIFICATION_DECISION_TREE, CLASSIFICATION_ADAPTIVE_TREE, \
