...
class Encoding(CommonModel):
    ...
    value_encoding = models.CharField(choices=VALUE_ENCODING_MAPPINGS, default='simpleIndex', max_length=20)
    ...
    task_generation_type = models.CharField(choices=TASK_GENERATION_TYPE_MAPPINGS, default='only_this', max_length=20)
