...
class Explanation(CommonModel):
    type = models.CharField(choices=EXPLANATION_TYPE_MAPPINGS, default='shap', max_length=max(len(el[1]) for el in EXPLANATION_TYPE_MAPPINGS)+1, null=True, blank=True)
